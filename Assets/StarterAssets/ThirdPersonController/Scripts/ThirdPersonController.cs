...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            // Постепенно уменьшаем импульс прыжка
            _jumpImpulse = Vector3.Lerp(_jumpImpulse, Vector3.zero, Time.deltaTime * 3f);

            // Финальное движение с учётом импульса
            Vector3 finalMove = (targetDirection.normalized * _speed + _jumpImpulse) * Time.deltaTime +
